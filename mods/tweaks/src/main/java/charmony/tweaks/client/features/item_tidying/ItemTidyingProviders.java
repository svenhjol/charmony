package charmony.tweaks.client.features.item_tidying;

import com.mojang.datafixers.util.Pair;
import net.minecraft.client.gui.screens.Screen;
import net.minecraft.client.gui.screens.inventory.*;
import charmony.api.tweaks.ItemTidyingBlacklistProvider;
import charmony.api.tweaks.ItemTidyingButtonTweak;
import charmony.api.tweaks.ItemTidyingButtonTweakProvider;
import charmony.api.tweaks.ItemTidyingWhitelistProvider;
