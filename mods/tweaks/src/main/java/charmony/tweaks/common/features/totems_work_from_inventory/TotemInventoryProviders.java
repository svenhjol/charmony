package charmony.tweaks.common.features.totems_work_from_inventory;

import net.minecraft.world.entity.player.Player;
import net.minecraft.world.item.ItemStack;
import net.minecraft.world.item.Items;
import charmony.api.tweaks.TotemInventoryCheckProvider;
import charmony.api.tweaks.TotemType;
