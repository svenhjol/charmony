package charmony.tweaks.common.mixins.totems_work_from_inventory;

import charmony.tweaks.common.features.totems_work_from_inventory.Handlers;
...
public class LivingEntityMixin {
    /**
     * Defer to {@link Handlers#tryUsingTotemOfUndying}
