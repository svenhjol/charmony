...
/**
 * Adds custom behavior to vanilla smithing tables.
 */
@SuppressWarnings("unused")
public final class SmithingTableEvents {
    ...
    public static class CanPlaceEvent extends CharmonyEvent<CanPlaceEvent.Handler> {
        private CanPlaceEvent() {}

        public boolean invoke(SmithingTableInstance instance, Integer slot, ItemStack stack) {
            for (Handler handler : getHandlers()) {
                if (handler.run(instance, slot, stack)) {
                    return true;
                }
            }
        ...
        public interface Handler {
            boolean run(SmithingTableInstance instance, Integer slot, ItemStack stack);
        }
    }

    public static class CalculateOutputEvent extends CharmonyEvent<CalculateOutputEvent.Handler> {
    ...
    public static class CanTakeEvent extends CharmonyEvent<CanTakeEvent.Handler> {
