...
public final class Resources {
    ...
    public static final Component COLLECT_TYPE = Component.translatable("gui.charmony.villager_tasks.type.collect");
    public static final Component MISSINGNO = Component.translatable("gui.charmony.villager_tasks.missingno");
    public static final Component MULTIPLE_REQUIREMENTS = Component.translatable("gui.charmony.villager_tasks.multiple_requirements");
