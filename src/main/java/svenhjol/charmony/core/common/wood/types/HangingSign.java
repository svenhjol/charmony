...
public class HangingSign extends CustomWood {
    ...
    public HangingSign(WoodRegistry woodRegistry, WoodMaterial material) {
        ...
        hangingBlock = commonRegistry.block(hangingId, key -> new CustomCeilingHangingSignBlock(key, material, woodType));
        wallBlock = woodRegistry.wallHangingSignBlock(wallId, material, woodType);
        ...
        woodRegistry.addItemToCreativeTab(item, material, CustomWoodType.HANGING_SIGN);
    }
}
